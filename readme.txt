...
Donate link: http://www.dongaines.com/acf-media-credit
...
I suggest using ACF Pro with this plugin. However, it also works with ACF Free & the ACF Repeater Premium Add-On.
...
2. If you've downloaded this from GitHub then just drop the entire 'acf-media-credit' directory into your plugins directory, go to the Plugins screen and activate 'ACF Media Credit'.
